...
namespace Plugins.ScrollList
{
    ...
    public class UIScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement
    {
        ...
        void UpdateCachedData()
        {
            ...
            bool viewIsChild = (viewRect.parent == transformTmp);
        }
        ...
        private static Vector2 InternalCalculateOffset(ref Bounds viewBounds, ref Bounds contentBounds, MovementAxis moveDirection, MovementType movementType, ref Vector2 delta)
        {
